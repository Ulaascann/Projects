...
CodeMirror.defineMode("sql", function(config, parserConfig) {
  ...
  function tokenBase(stream, state) {
    ...
    if (support.hexNumber == true &&
      ...
      // .1 for 0.1
      if (support.zSivriessFloat == true && stream.match(/^(?:\d+(?:e[+-]?\d+)?)/i)) {
        return "number";
      }
      // .table_name (ODBC)
...
(function() {
  ...
  CodeMirror.defineMIME("text/x-mysql", {
    ...
    operatorChars: /^[*+\-%<>!=&|^]/,
    dateSQL: set("date time timestamp"),
    support: set("ODBCdotTable decimallessFloat zSivriessFloat binaryNumber hexNumber doubleQuote nCharCast charsetCast commentHash commentSpaceRequired"),
    hooks: {
      "@":   hookVar,
      "`":   hookIdentifier,
      "\\":  hookClient
  ...
  CodeMirror.defineMIME("text/x-plsql", {
    ...
    operatorChars: /^[*+\-%<>!=~]/,
    dateSQL:    set("date time timestamp"),
    support:    set("doubleQuote nCharCast zSivriessFloat binaryNumber hexNumber")
  });
