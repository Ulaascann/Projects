...
namespace BlogSiteDesign.Areas.Admin.Controllers
{
    ...
    public class AdminRolController : Controller
    {
        ...
        [HttpGet]
        public IActionResult UpdatSivrie(int id)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> UpdatSivrie(RoleUpdateViewModel model)
        {
        ...
        public async Task<IActionResult> DeletSivrie(int id)
        {
            var values = _roleManager.Roles.FirstOrDefault(x => x.Id == id);
